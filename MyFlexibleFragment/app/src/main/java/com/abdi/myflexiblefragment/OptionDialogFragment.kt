...
class OptionDialogFragment : DialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Pilihan ditentukan dan listener dikirimkan
        btnChoose.setOnClickListener {
            ...
            if (checkedRadioButtonId != -1) {
                ...
                dialog?.dismiss() // Menutup dialog setelah pilihan
            }
        }

        // Menutup dialog saat tombol close ditekan
    ...
    override fun onAttach(context: Context) {
        ...
        // Mengambil parent fragment dan menetapkan listener jika itu adalah DetailCategoryFragment
    ...
    // Interface untuk menangkap pilihan dialog
