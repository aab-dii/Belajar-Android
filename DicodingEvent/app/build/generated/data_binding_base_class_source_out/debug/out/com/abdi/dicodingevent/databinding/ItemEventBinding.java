...
package com.abdi.dicodingevent.databinding;
...
public final class ItemEventBinding implements ViewBinding {
  ...
  private ItemEventBinding(@NonNull CardView rootView, @NonNull ImageView eventImg,
  ...
  public static ItemEventBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemEventBinding((CardView) rootView, eventImg, tvTitle);
    }
